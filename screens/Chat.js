...
import { View, Text, TouchableOpacity, KeyboardAvoidingView, Platform, StyleSheet, TextInput, Keyboard, TouchableWithoutFeedback, } from 'react-native'
        ...
        <SafeAreaView style={{ flex: 1, backgroundColor: 'white'}}>
            ...
            >
                ...
                <View style={styles.footer}>
                    <TextInput value={input} onChangeText={(text) => setInput(text)} placeholder="Send Message" style={styles.textInput}/>
